...
const Privacy = () => {
  ...
  return (
    <>
      {locale === "it" ? (
        <div className="container mx-auto pt-5 p-2 xl:p-8 bg-pink text-third min-h-[calc(100vh_-_70px)] w-full mt-[70px]">
          <h1 className="text-3xl md:text-[52px] 3xl:text-[100px] font-medium mt-2 3xl:mt-12 leading-10 pb-6">
            Informativa sulla privacy
          </h1>
          <p>Data di entrata in vigore: 12-10-2023</p>
          <p>Ultimo aggiornamento: 13-10-2023</p>
          <p>
            La presente Informativa sulla privacy spiega le politiche di Elisa
            Avantey sulla raccolta e l&apos;uso delle informazioni che
            raccogliamo quando accedi a https://www.miaographics.it// (il
          ...
          <p>
            Elisa Avanteyè autorizzata a modificare la presente Informativa
            sulla privacy in qualsiasi momento. Questo può avvenire senza
            preavviso.
          </p>
          <p>
            Elisa Avanteypubblicherà l&apos;Informativa sulla privacy modificata
            sul sito web https://www.miaographics.it//.
          </p>
          ...
          <p>
            ...
            identificarti. https://www.miaographics.it// raccoglie le seguenti
            informazioni:{" "}
          </p>
          ...
          <p>
            https://www.miaographics.it// raccoglie e riceve informazioni da
            parte tua nelle seguenti modalità:{" "}
          </p>
          <ul>
            <li>
          ...
          <p>
            https://www.miaographics.it// può utilizzare le tue informazioni per
            i seguenti scopi:{" "}
          </p>
          <ul>
            <li>
            ...
            <li>
              <b>Per altri scopi.</b> Elisa Avanteyuserà le tue informazioni per
          ...
          <h4 className="text-3xl md:text-[28px] 3xl:text-[100px] font-medium mt-2 3xl:mt-12 leading-10 text-pink pb-45">
            Come condividiamo le tue informazioni
          </h4>
          <p>
            Elisa Avanteycondividerà le tue informazioni, se del caso, nelle
            seguenti situazioni:{" "}
          </p>
          <ul>
            <li>
              <b>Con il tuo consenso.</b> Elisa Avanteycondividerà le tue
          ...
          <p>
            ...
            altro modo, stai dando a Elisa Avanteyil permesso di utilizzare,
          ...
          <p>
            ...
            https://www.miaographics.it// utilizza una serie di misure di
            sicurezza per prevenire l&apos;uso improprio, la perdita o
          ...
          <p>
            Elisa Avanteynon è responsabile delle prestazioni dei siti web
            gestiti da terzi o delle tue interazioni con essi. Quando abbandoni
            questo sito web, ti consigliamo di rivedere le pratiche in materia
            di privacy degli altri siti web con cui interagisci e determinare
        ...
        <div className="container mx-auto pt-5 p-2 xl:p-8 bg-pink text-third min-h-[calc(100vh_-_70px)] w-full mt-[70px]">
          ...
          <p>Effective date: 21-03-2023</p>
          <p>Updated on: 21-03-2023</p>
          <p>
            This Privacy Policy explains the policies of Elisa Avanteyon the
            collection and use of the information we collect when you access
            https://www.miaographics.it// (the “Service”). This Privacy Policy
          ...
          <p>
            Elisa Avanteyis authorized to modify this Privacy Policy at any
            time. This may occur without prior notice.
          </p>
          <p>
            Elisa Avanteywill post the revised Privacy Policy on the
            https://www.miaographics.it// website
          </p>
          ...
          <p>
            ...
            https://www.miaographics.it// collects the following information:{" "}
          </p>
          ...
          <p>
            https://www.miaographics.it// collects and receives information from
          ...
          <p>
            https://www.miaographics.it// may use your information for the
            following purposes:{" "}
          </p>
          <ul>
            <li>
            ...
            <li>
              <b>For other purposes.</b> Elisa Avanteywill use your information
              for data analysis to identify usage trends or determine the
              effective of our marketing campaigns when reasonable. We will use
              your information to evaluate and improve our Service, products,
          ...
          <p>
            Elisa Avanteywill share your information, when applicable, in the
            following situations:{" "}
          </p>
          <ul>
            <li>
              <b>With your consent.</b> Elisa Avanteywill share your information
              for any purpose with your explicit consent.
            </li>
          </ul>
          ...
          <p>
            ...
            otherwise, you are giving Elisa Avanteypermission to use, share, and
            store that information in a manner consistent with this Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            ...
            https://www.miaographics.it// utilizes a range of security measures
            to prevent the misuse, loss, or alteration of the information you
            have given us. However, because we cannot guarantee the security of
            the information you provide us, you must access our service at your
            own risk.{" "}
          </p>
          <p>
            Elisa Avanteyis not responsible for the performance of websites
            operated by third parties or your interactions with them. When you
            leave this website, we recommend you review the privacy practices of
            other websites you interact with and determine the adequacy of those
            practices.{" "}
          </p>
