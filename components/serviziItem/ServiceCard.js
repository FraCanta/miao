...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    <div className="relative h-[52%] shrink-0 overflow-hidden bg-main/5">
      ...
      />
      <span className="absolute right-4 top-4 bg-main px-2 py-1 text-[10px] font-bold tracking-[0.18em] text-white">
    ...
    <div className="flex min-h-0 flex-1 flex-col p-5 md:p-6 2xl:p-5">
      ...
      <p className="mt-3 line-clamp-3 text-sm leading-relaxed text-second transition-colors group-hover:text-white/70 2xl:text-base">
        {service.descrizione}
      </p>
